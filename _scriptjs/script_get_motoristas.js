    ...
    $.ajax({
        ...
        success: (result) => {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                confirm += ("<td>" + '<input type="text" style="width: 135px;" class="cpf_motorista form-control" data-id="' + id + '" id="cpf_motorist'+(parseInt(i) + 1)+ ' " value="'+result[i]['cpf_motorista']+'" aria-describedby="basic-addon3 basic-addon4" maxlength="14" oninput="formatarCPF(this)"></input>' + "</td>");
                ...
                confirm += ("<td>" + '<input type="text" style="width: 105px;" class="placa_caminhao form-control" data-id="' + id + '" id="placa_caminhao'+ (parseInt(i) + 1) +'" value="'+result[i]['placa_caminhao']+'" aria-describedby="basic-addon3 basic-addon4" maxlength="8"></input>' + "</td>");
    
                confirm += ("<td><select data-id='" + id + "' name='tipo' style='width: 90px;' class='modelo_caminhao form-select'>");
                ...
                confirm += ("<td>" + '<input type="text" style="width: 110px;" class="venci_habilitacao form-control" data-id="' + id + '" id="venci_habilitacao'+ (parseInt(i) + 1) +'" value="'+result[i]['venci_habilitacao']+'" aria-describedby="basic-addon3 basic-addon4"></input>' + "</td>");
                confirm += "</tr>";
            }
