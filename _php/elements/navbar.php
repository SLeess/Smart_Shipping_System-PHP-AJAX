<nav class="navbar fixed-top">
    <div class="container-fluid">
        <button style="background-color: #041855;" class="navbar-toggler bg-body-tertiary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <main class="sidebar d-flex flex-column flex-shrink-0 p-3" style="min-height: 100vh;box-shadow: rgba(0, 0, 0, 0.15) 2.4px 2.4px 3.2px;max-height: 100vh;">
                <!--text-white-->
                <a href="<?php echo $relative; ?>home.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-black text-decoration-none">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        ...
                        <!--text-white-->
                        <a href="<?php echo $relative; ?>home.php" class="nav-link text-black" aria-current="page" onmouseenter="sobre(this, 1);" onmouseleave="sobre(this,0)">
                    ...
                    <li class="nav-item">
                        <!--text-white-->
                        <a href="<?php echo $relative; ?>3SSI-CRUD/notas.php" class="nav-link text-black" aria-current="page" onmouseenter="sobre(this, 1);" onmouseleave="sobre(this,0)">
                    ...
                    <li class="nav-item">
                        <!--text-white-->
                        <a href="<?php echo $relative; ?>motoristas_caminhoes.php" class="nav-link text-black" aria-current="page" onmouseenter="sobre(this, 1);" onmouseleave="sobre(this,0)">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu text-small shadow" style="margin-top: -220px;">
                        <li><a class="dropdown-item" href="<?php echo $relative; ?>perfil_configs.php">Perfil</a></li>
                        <li><a class="dropdown-item" href="#">Configurações</a></li>
                        <li><a class="dropdown-item" href="#">FAQ</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo $relative; ?>CRUD/logout.php">Sair</a></li>
                    </ul>
                </div>
            </main>
